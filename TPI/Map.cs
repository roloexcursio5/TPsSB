namespace TPI
{
    internal static class Map
    {
        ...
        static public Location ClosestLandTypeLocation(Barrack operatorx, EnumLandType landType)
        {
        ...
        ////////////////////////////////////////////////////////////////
        ///FALTA FUNCIONA PERO QUEDÓ COMO MUY SMELLY, LO DEBO CORREGIR PARA CLARIFICAR JUNTO CON OTROS PUNTOS.
        ...
        */
        ...
        static private Land[,] TripSubMap(Operator operatorx, Location destination)
        {
            ...
            //    }
            //}
            Land[,] tripSubMap = new Land[100, 100];
            return tripSubMap;
        }
